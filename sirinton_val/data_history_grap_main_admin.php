        ...
        $sql = "SELECT * FROM `val_water_sirinton` LEFT JOIN val_wather_sirinton on val_water_sirinton.date = val_wather_sirinton.date_wather_sirinton WHERE `date` LIKE '%$y_m_sql%' ORDER BY `val_water_sirinton`.`date` ASC;";
                      $result = mysqli_query($conn, $sql);
                        while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                            ...
                            $date_water_sirinton =  $row['date'];

                            $date_ex = explode("-", $date_water_sirinton);
                            $day = $date_ex[2];
      ...
      <tr class="users-table-info">
        ...
        <td><button id="myBtn<?=$num?>" class="badge-active" type="button">แก้ไข</button></td>
											...
											<div class="modal-body">
												<form>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="level_water_sirinton<?=$num?>" value="<?=$level_water_sirinton;?>"/> <span style="margin-left:100px">ม.(รทก.)</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="amount_water_sirinton<?=$num?>" value="<?=$amount_water_sirinton;?>"/> <span style="margin-left:100px">ลบ.ม./ว</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="temp_wather_sirinton<?=$num?>" value="<?=$temp_wather_sirinton;?>"/> <span style="margin-left:100px">°C</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="humidity_wather_sirinton<?=$num?>" value="<?=$humidity_wather_sirinton;?>"/> <span style="margin-left:100px">%</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="wind_wather_sirinton<?=$num?>" value="<?=$wind_wather_sirinton;?>"/> <span style="margin-left:100px">กม/ชม</span>
												    </div>
												  </div>
													<br>
													<div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="land_visibility_wather_sirinton<?=$num?>" value="<?=$land_visibility_wather_sirinton;?>"/> <span style="margin-left:100px">กิโลเมตร</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="MeanSeaLevelPressure_wather_sirinton<?=$num?>" value="<?=$MeanSeaLevelPressure_wather_sirinton;?>"/> <span style="margin-left:100px">hPa</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
			...
			function updateData<?=$num?>(){
				var date_up = "<?=$m_y_js?>";
				var date_sql = "<?=$date_water_sirinton?>";

				var level_water_sirinton<?=$num?> = document.getElementsByName("level_water_sirinton<?=$num?>")[0].value;
				var amount_water_sirinton<?=$num?> = document.getElementsByName("amount_water_sirinton<?=$num?>")[0].value;

				var temp_wather_sirinton<?=$num?> = document.getElementsByName("temp_wather_sirinton<?=$num?>")[0].value;
				var humidity_wather_sirinton<?=$num?> = document.getElementsByName("humidity_wather_sirinton<?=$num?>")[0].value;
				var wind_wather_sirinton<?=$num?> = document.getElementsByName("wind_wather_sirinton<?=$num?>")[0].value;
				var land_visibility_wather_sirinton<?=$num?> = document.getElementsByName("land_visibility_wather_sirinton<?=$num?>")[0].value;
				var MeanSeaLevelPressure_wather_sirinton<?=$num?> = document.getElementsByName("MeanSeaLevelPressure_wather_sirinton<?=$num?>")[0].value;

				modal<?=$num?>.style.display = "none";
				$.ajax({
								url: "manager_sql.php?update4_data", //เรียกใช้งานไฟล์นี้
		 						data: "&level_water_sirinton="+level_water_sirinton<?=$num?>+"&amount_water_sirinton="+amount_water_sirinton<?=$num?>+"&temp_wather_sirinton="+temp_wather_sirinton<?=$num?>+"&humidity_wather_sirinton="+humidity_wather_sirinton<?=$num?>+"&wind_wather_sirinton="+wind_wather_sirinton<?=$num?>+"&land_visibility_wather_sirinton="+land_visibility_wather_sirinton<?=$num?>+"&MeanSeaLevelPressure_wather_sirinton="+MeanSeaLevelPressure_wather_sirinton<?=$num?>+"&date="+date_sql,
		 						type: "GET",
		 						async:false,
