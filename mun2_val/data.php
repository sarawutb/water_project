...
$date = date("Y-m-d");
$sql = "SELECT * FROM `val_wather_mun2` WHERE date_wather_mun2 = '$date' ORDER BY `val_wather_mun2`.`id_wather_mun2` ASC";
...
<div class="row stat-cards">
  ...
  <div class="col-md-6 col-xl-3">
    <article class="stat-cards-item">
      ...
      <div class="stat-cards-info">
        <h1 class="stat-cards-info__num" style="font-size:30px"><?= $temp_wather_mun2; ?> °C</h1>
        <p class="stat-cards-info__progress">
          <?php
          if ($temp_wather_mun2 >= 29) {
            echo '<span class="stat-cards-info__profit danger"><i data-feather="sun" aria-hidden="true"></i>';
          } else if ($temp_wather_mun2 >= 23 && $temp_wather_mun2 <= 28.9) {
          ...
          if ($temp_wather_mun2 >= 40) {
            echo "อากาศร้อนจัด";
          } else if ($temp_wather_mun2 >= 35 && $temp_wather_mun2 <= 39.9) {
            echo "อากาศร้อน";
          } else if ($temp_wather_mun2 >= 29 && $temp_wather_mun2 <= 34.9) {
            echo "อากาศค่อนข้างร้อน";
          } else if ($temp_wather_mun2 >= 23 && $temp_wather_mun2 <= 28.9) {
            echo "อากาศปกติ";
          } else if ($temp_wather_mun2 >= 18 && $temp_wather_mun2 <= 22.9) {
            echo "อากาศเย็น";
          } else if ($temp_wather_mun2 >= 16 && $temp_wather_mun2 <= 17.9) {
            echo "อากาศค่อนข้างหนาว";
          } else if ($temp_wather_mun2 >= 8 && $temp_wather_mun2 <= 15.9) {
            echo "อากาศหนาว";
          } else if ($temp_wather_mun2 < 8) {
            echo "อากาศหนาวจัด";
          }
          ?>
          </span>
        ...
        <p style="margin-top:10px"></p>
        <h1 class="stat-cards-info__num" style="font-size:30px"><?= $humidity_wather_mun2; ?> %</h1>
  ...
  <div class="col-md-6 col-xl-3">
    <article class="stat-cards-item">
      ...
      <div class="stat-cards-info">
        <?php
        // if($wind_wather_mun2 <= 0){
        //   $wind_wather_mun2 = "ลมสงบ";
        // }else{
        // $wind_wather_mun2 = $wind_wather_mun2." กม/ชม";
        // }
        ?>
        <?php
        $wind_wather_mun2 = $wind_wather_mun2 . " กม/ชม";
        ?>
        <h1 class="stat-cards-info__num" style="font-size:30px"><?= $wind_wather_mun2; ?> </h1>
        <p <?php
            if ($wind_wather_mun2 <= 0) {
              echo "hidden";
            }
        ...
        <p class="stat-cards-info__progress">
          <span class="stat-cards-info__profit success">
            <?php
            if ($wind_wather_mun2 <= 0) {
              $wind_wather_mun2_val = "ลมสงบ";
            } else if ($wind_wather_mun2_val <= 10) {
              $wind_wather_mun2_val = "ลมอ่อน";
            } else if ($wind_wather_mun2 > 10) {
              $wind_wather_mun2_val = "ลมแรง";
            }
            echo $wind_wather_mun2_val;
            ?>
          </span>
        </p>
        ...
        <!-- <p class="stat-cards-info__progress">
          ทัศนวิสัย&nbsp;
            <span class="stat-cards-info__profit success">
               <?= $land_visibility_wather_mun2; ?> กิโลเมตร
            </span>
        </p> -->
        <h1 class="stat-cards-info__num" style="font-size:30px"><?= $land_visibility_wather_mun2; ?> กิโลเมตร</h1>
  ...
  <div class="col-md-6 col-xl-3">
    <article class="stat-cards-item">
      ...
      <div class="stat-cards-info">
        <p class="stat-cards-info__num" style="font-size:30px"><?= $MeanSeaLevelPressure_wather_mun2; ?> hPa</p>
        <p class="stat-cards-info__progress">
          <span class="stat-cards-info__profit primary" style="color:#0073e6;">
            <!-- <p > -->
            <?= "มี" . $rainfall_wather_mun2; ?>
            <!-- </p> -->
          </span>
        </p>
        ...
        <!-- <p class="stat-cards-info__progress">
          <h1 class="stat-cards-info__num" style="font-size:25px;color:#0073e6;"><?= $rainfall_wather_mun2; ?> </h1>
          <p
