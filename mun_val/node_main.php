...
$sql = "SELECT * FROM `val_water` WHERE date = '$date' ORDER BY `val_water`.`id_water` ASC";
  ...
  $sql = "SELECT * FROM `val_tmd` WHERE `date_tmd` = '$date' ORDER BY `val_tmd`.`date_tmd` ASC";
...
<h2 class="main-title">รายงานสถิติข้อมูล แม่น้ำมูล (M.7)</h2>
<!-- <h2 class="main-title">สถานีตรวจวัด อ่างเก็บน้ำห้วยวังนอง(NB01)</h2> -->
    ...
    <div class="col-md-6 col-xl-3">
      <article class="stat-cards-item">
        ...
        <div class="stat-cards-info">
          ...
          <h1 class="stat-cards-info__num" style="font-size:30px"> <font style="font-size:30px"><?=$amount_water?></font><font style="font-size:15px"> ลบ.ม./ว</font></h1>
  ...
  <article class="white-block">
   ...
   <script>
       ...
       $.ajax({
           url: "mun_val/data_history_grap_main.php?", //เรียกใช้งานไฟล์นี้
           data: "date="+m_y_date,
           type: "GET",
           async:false,
