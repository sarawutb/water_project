    ...
    <article class="stat-cards-item">
      ...
      <div class="stat-cards-info">
        <p class="stat-cards-info__progress">
          <span class="stat-cards-info__profit warning" style="font-size:18px;">
            <?php
            ...
            ?>
            ระดับเตือนภัย <?= $level_water_max1 ?> <b style="font-size:15px;">&nbsp; ม.(รทก.)</b>
          </span>
        </p>
        ...
        <h1 class="stat-cards-info__num" style="font-size:30px"><?= $amount_water; ?> <font style="font-size:20px">ลบ.ม./ว</font>
        </h1>
    ...
    <article class="stat-cards-item">
      ...
      <div class="stat-cards-info">
        ...
        <p class="stat-cards-info__progress">
          <?php
          if ($temp_tmd >= 29) {
            echo '<span class="stat-cards-info__profit danger" style="font-size:18px;">';
          } else if ($temp_tmd >= 23 && $temp_tmd <= 28.9) {
            echo '<span class="stat-cards-info__profit success" style="font-size:18px;">';
          } else {
            echo '<span class="stat-cards-info__profit primary" style="font-size:18px;color:#3399ff;">';
          }
          if ($temp_tmd >= 40) {
            echo "อากาศร้อนจัด";
