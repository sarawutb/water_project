  ...
  <table class="posts-table">
    ...
    <tbody>
      ...
      <tr class="users-table-info">
        ...
        <td style="text-align: center;"><?=$tempNb3;?></td>
        <td style="text-align: center;"><?=$humidNb3;?></td>
        <td style="text-align: center;"><?=$lightNb3;?></td>
        <td style="text-align: center;"><?=$rssiNb3;?></td>
        <td><button id="myBtn<?=$num?>" class="badge-active" type="button">แก้ไข</button></td>
											...
											<div class="modal-body">
												<form>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="level_water_Nb3<?=$num?>" value="<?=$distanceNb3;?>"/> <span style="margin-left:100px">ม.(รทก.)</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="temp_Nb3<?=$num?>" value="<?=$tempNb3;?>"/> <span style="margin-left:100px">°C</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="humidity_Nb3<?=$num?>" value="<?=$humidNb3;?>"/> <span style="margin-left:100px">%</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="light_Nb3<?=$num?>" value="<?=$lightNb3;?>"/> <span style="margin-left:100px">lux</span>
												    </div>
												  </div>
													<br>
													<div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="rssi_Nb3<?=$num?>" value="<?=$rssiNb3;?>"/> <span style="margin-left:100px">Db</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
			...
			function updateData<?=$num?>(){
				var date_up = "<?=$m_y_js?>";
				var date_sql = "<?=$dateNb3?>";

				var level_water_Nb3<?=$num?> = document.getElementsByName("level_water_Nb3<?=$num?>")[0].value;
				var temp_Nb3<?=$num?> = document.getElementsByName("temp_Nb3<?=$num?>")[0].value;
				var humidity_Nb3<?=$num?> = document.getElementsByName("humidity_Nb3<?=$num?>")[0].value;
				var light_Nb3<?=$num?> = document.getElementsByName("light_Nb3<?=$num?>")[0].value;
				var rssi_Nb3<?=$num?> = document.getElementsByName("rssi_Nb3<?=$num?>")[0].value;

				modal<?=$num?>.style.display = "none";
				$.ajax({
								url: "manager_sql.php?update_nb3_data", //เรียกใช้งานไฟล์นี้
		 						data: "&level_water_Nb3="+level_water_Nb3<?=$num?>+"&temp_Nb3="+temp_Nb3<?=$num?>+"&humidity_Nb3="+humidity_Nb3<?=$num?>+"&light_Nb3="+light_Nb3<?=$num?>+"&rssi_Nb3="+rssi_Nb3<?=$num?>+"&date="+date_sql,
		 						type: "GET",
		 						async:false,
