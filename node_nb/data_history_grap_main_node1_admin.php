  ...
  <table class="posts-table">
    ...
    <tbody>
      ...
      <tr class="users-table-info">
        ...
        <td style="text-align: center;"><?=$tempNb1;?></td>
        <td style="text-align: center;"><?=$humidNb1;?></td>
        <td style="text-align: center;"><?=$lightNb1;?></td>
        <td style="text-align: center;"><?=$rssiNb1;?></td>
        <td><button id="myBtn<?=$num?>" class="badge-active" type="button">แก้ไข</button></td>
											...
											<div class="modal-body">
												<form>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="level_water_Nb1<?=$num?>" value="<?=$distanceNb1;?>"/> <span style="margin-left:100px">ม.(รทก.)</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="temp_Nb1<?=$num?>" value="<?=$tempNb1;?>"/> <span style="margin-left:100px">°C</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="humidity_Nb1<?=$num?>" value="<?=$humidNb1;?>"/> <span style="margin-left:100px">%</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="light_Nb1<?=$num?>" value="<?=$lightNb1;?>"/> <span style="margin-left:100px">lux</span>
												    </div>
												  </div>
													<br>
													<div class="form-group row">
												    ...
												    <div class="col-sm-10">
												      <input type="number" name="rssi_Nb1<?=$num?>" value="<?=$rssiNb1;?>"/> <span style="margin-left:100px">Db</span>
												    </div>
												  </div>
													<br>
												  <div class="form-group row">
			...
			function updateData<?=$num?>(){
				var date_up = "<?=$m_y_js?>";
				var date_sql = "<?=$dateNb1?>";

				var level_water_Nb1<?=$num?> = document.getElementsByName("level_water_Nb1<?=$num?>")[0].value;
				var temp_Nb1<?=$num?> = document.getElementsByName("temp_Nb1<?=$num?>")[0].value;
				var humidity_Nb1<?=$num?> = document.getElementsByName("humidity_Nb1<?=$num?>")[0].value;
				...
				$.ajax({
								url: "manager_sql.php?update_nb1_data", //เรียกใช้งานไฟล์นี้
		 						data: "&level_water_Nb1="+level_water_Nb1<?=$num?>+"&temp_Nb1="+temp_Nb1<?=$num?>+"&humidity_Nb1="+humidity_Nb1<?=$num?>+"&light_Nb1="+light_Nb1<?=$num?>+"&rssi_Nb1="+rssi_Nb1<?=$num?>+"&date="+date_sql,
		 						type: "GET",
		 						async:false,
