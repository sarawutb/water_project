																					...
																					<div class="form-group row">
																						...
																						<div class="col-sm-5">
																							<div class="form-group row">
																								...
																								<b id="status_offTb<?= $device_id ?>" class="stat-cards-info__profit" style="margin: 5px 0px 0px 10px; font-size: 15px;"> ปิด</b>
																								<b id="status_onTb<?= $device_id ?>" class="stat-cards-info__profit success" style="margin: 5px 0px 0px 10px; font-size: 15px;"> เปิด</b>
																							</div>
																							<script>
