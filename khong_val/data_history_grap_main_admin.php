  ...
  <table class="posts-table">
    ...
    <tbody>
      <?php
        ...
        $rainfall_tmd = "-";
        $land_visibility_tmd = "-";
        $sql = "SELECT * FROM `val_water_khong` LEFT JOIN val_wather_khong on val_water_khong.date = val_wather_khong.date_tmd WHERE `date` LIKE '%$y_m_sql%' ORDER BY `val_water_khong`.`date` ASC;";
